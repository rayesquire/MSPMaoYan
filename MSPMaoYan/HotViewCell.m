...
- (void)initialization {
    ...
    [self.contentView addConstraints:
     [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-10-[_poster(50)]"
                                             options:0
                                             metrics:nil
                                               views:NSDictionaryOfVariableBindings(_poster)]];
    [self.contentView addConstraints:
     [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-10-[_poster(70)]"
                                             options:0
                                             metrics:nil
                                               views:NSDictionaryOfVariableBindings(_poster)]];
    ...
    [self.contentView addConstraints:
     [NSLayoutConstraint constraintsWithVisualFormat:@"H:[_poster]-10-[_name]"
                                             options:0
                                             metrics:nil
                                               views:NSDictionaryOfVariableBindings(_name,_poster)]];
    [self.contentView addConstraints:
     [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-20-[_name]"
                                             options:0
                                             metrics:nil
    ...
    [self.contentView addConstraints:
     [NSLayoutConstraint constraintsWithVisualFormat:@"H:[_name]-10-[_threeD]"
                                             options:0
                                             metrics:nil
                                               views:NSDictionaryOfVariableBindings(_threeD,_name)]];
    [self.contentView addConstraints:
     [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-20-[_threeD]"
                                             options:0
                                             metrics:nil
    ...
    [self.contentView addConstraints:
     [NSLayoutConstraint constraintsWithVisualFormat:@"H:[_threeD]-0-[_iMax]"
                                             options:0
                                             metrics:nil
                                               views:NSDictionaryOfVariableBindings(_iMax,_threeD)]];
    [self.contentView addConstraints:
     [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-20-[_iMax]"
                                             options:0
                                             metrics:nil
    ...
    [self.contentView addConstraints:
     [NSLayoutConstraint constraintsWithVisualFormat:@"H:[_like]-10-|"
                                             options:0
                                             metrics:nil
                                               views:NSDictionaryOfVariableBindings(_like)]];
    [self.contentView addConstraints:
     [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-25-[_like]"
                                             options:0
                                             metrics:nil
                                               views:NSDictionaryOfVariableBindings(_like)]];
    ...
    [self.contentView addConstraints:
     [NSLayoutConstraint constraintsWithVisualFormat:@"H:[_poster]-10-[_introduction]|"
                                             options:0
                                             metrics:nil
                                               views:NSDictionaryOfVariableBindings(_introduction,_poster)]];
    [self.contentView addConstraints:
     [NSLayoutConstraint constraintsWithVisualFormat:@"V:[_name]-20-[_introduction]"
                                             options:0
                                             metrics:nil
    ...
    [self.contentView addConstraints:
     [NSLayoutConstraint constraintsWithVisualFormat:@"H:[_poster]-10-[_situation]|"
                                             options:0
                                             metrics:nil
                                               views:NSDictionaryOfVariableBindings(_situation,_poster)]];
    [self.contentView addConstraints:
     [NSLayoutConstraint constraintsWithVisualFormat:@"V:[_introduction]-5-[_situation]"
                                             options:0
                                             metrics:nil
